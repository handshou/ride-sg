 ...
 * Uses Effect Ref.Synchronized for reactive state management across services.
 */
...
/**
 * Implementation of Search State Service
 */
export const SearchStateServiceLive = Layer.effect(
...
export const startSearchEffect = (query: string) =>
  ...
  }).pipe(Effect.provide(SearchStateServiceLive));
